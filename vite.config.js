...
export default (function (_a) {
        ...
        css: {
            ...
            modules: {
                ...
                generateScopedName: function (name, filename, css) {
                    ...
                    return "".concat(componentName, "__").concat(name, "-").concat(hash).concat(numberInRange(10, 100));
                },
            },
        },
    });
    function numberInRange(start, end) {
        var range = end - start;
        if (range <= 0) {
            throw new Error('randNumberInRange error: "end" <= "start", range = '.concat("".concat(range)));
        }
